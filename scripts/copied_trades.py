...
def claim_trade(
    ...
    try:
        ...
        # Fail-closed: treat as already-claimed so we don't double-trade on
        # transient DB errors.
        return False
...
def trader_exposure(source_wallet: str) -> float:
    ...
    This is an upper bound — we don't track sell-reconciliation yet — which is
    the conservative bias we want for a risk cap.
    """
    try:
        resp = (
